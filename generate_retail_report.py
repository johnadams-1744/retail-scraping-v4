...
add("papertrailrhinebeck.com", "TRUE", 1, "6423 Montgomery St, Rhinebeck, NY 12572", "$500K-$1M (Low confidence)", "1 stationery/gift shop in Rhinebeck NY; paper goods, gifts, cards", "Yes", "—")
...
add("germansausageaz.com", "TRUE", 1, "4900 East Indian School Road, Phoenix, AZ 85018", "$500K-$1.5M (Low confidence)", "1 German sausage/deli shop in Phoenix AZ; German meats, sausages, imported foods", "Yes", "—")
...
add("www.copperbottombrewing.com", "TRUE", 1, "567 Main Street, Montague, PE C0A 1R0, Canada", "$200K-$500K (Low confidence)", "1 craft brewery/taproom in Montague PEI; craft beer; small local brewery", "Yes", "—")
...
add("fortworthstreetsboutique.com", "TRUE", 1, "Fort Worth, TX (exact address not publicly listed)", "$200K-$500K (Low confidence)", "1 women's clothing boutique in Fort Worth TX; women's clothing and jewelry", "Yes", "—")
...
# --- BATCH 6 FINDINGS ---
add("polleybuilding.com", "TRUE", 1, "1335 S Obrien St, Seymour, IN 47274", "$1M-$5M (Low confidence)", "1 building supply store; construction materials, lumber, building supplies", "Yes", "—")
...
add("yeolesweets.com", "TRUE", 1, "402 State St, Erie, PA 16501", "$200K-$500K (Low confidence)", "1 candy/sweets shop in Erie PA; traditional sweets, candy, confections", "Yes", "—")
...
add("shopoxfordstreet.com", "TRUE", 4, "15555 East 14th Street, San Leandro, CA 94578 (BayFair Center); Citrus Heights CA; San Bruno CA; Plano TX", "$500K-$2M (Low confidence)", "4 retail stores; men's/children's apparel; BayFair in San Leandro CA (not Oklahoma)", "Yes", "—")
add("carbonshowroom.com", "FALSE", 0, "N/A", "$200K-$500K (Low confidence)", "Online carbon fiber products retailer", "Yes", "—")
add("www.mbgourds.com", "TRUE", 1, "125 Potato Road, Carlisle, PA 17015", "$500K-$2M (Low confidence)", "1 gourd craft retail location in PA; handcrafted gourds, seasonal decorations; 200-acre farm with 7000 sq ft gift shop", "Yes", "—")
add("dreyer-farms.myshopify.com", "TRUE", 1, "831 Springfield Ave, Cranford, NJ 07016", "$200K-$500K (Low confidence)", "1 farm and garden center in Cranford NJ; fresh produce, farm products; since 1904", "Yes", "—")
add("shopheadwatersoutdoors.com", "TRUE", 1, "25 Parkway Rd, Rosman, NC 28772", "$500K-$1.5M (Low confidence)", "1 outdoor outfitter shop; kayaking, hiking, outdoor adventure gear and tours", "Yes", "—")
...
add("www.306sportscards.com", "TRUE", 1, "718 Circle Dr E, Saskatoon, SK S7K 3T7, Canada", "$200K-$500K (Low confidence)", "1 sports card shop; trading cards, collectibles, memorabilia", "Yes", "—")
...
add("www.hammerlyceramics.com", "TRUE", 1, "8127 W. 94th Ave., Broomfield, CO 80021", "$200K-$500K (Low confidence)", "1 ceramics studio/gallery; handmade pottery, ceramics", "Yes", "—")
add("hammerlyceramics.com", "TRUE", 1, "8127 W. 94th Ave., Broomfield, CO 80021", "$200K-$500K (Low confidence)", "1 ceramics studio/gallery; handmade pottery, ceramics", "Yes", "—")
...
add("pigeonmountaintrading.com", "TRUE", 1, "106 N Main St, LaFayette, GA 30728", "$500K-$2M (Low confidence)", "1 outdoor/climbing supply store in LaFayette GA; climbing gear, caving equipment, outdoor supplies", "Yes", "—")
...
add("ojos-puerto-rico-clinica.myshopify.com", "TRUE", 3, "809 Calle Hipodromo, San Juan, PR 00909; Ave. Simón Madera 9 Villa Prades, San Juan, PR 00918; Carr 848 Km 0.2, Trujillo Alto, PR 00976", "$2M-$5M (Low confidence)", "3 eye clinic locations in Puerto Rico; eyewear, prescription glasses, optical products", "Yes", "—")
add("bernina-jeff.myshopify.com", "TRUE", 1, "2584 Patterson Rd Unit B, Grand Junction, CO 81505", "$500K-$2M (Low confidence)", "1 Bernina sewing machine dealer (Hi Fashion Sewing); sewing machines, accessories, 3D-printed items", "Yes", "—")
add("shop.tennisspectrum.com", "TRUE", 1, "16519 Brookhurst Street, Fountain Valley, CA 92708", "$500K-$1.5M (Low confidence)", "1 tennis retail shop; rackets, apparel, shoes, accessories", "Yes", "—")
...
add("stickley-museum.myshopify.com", "TRUE", 1, "2352 State Route 10, Morris Plains, NJ 07950", "$200K-$500K (Low confidence)", "1 museum gift shop at Stickley Museum at Craftsman Farms; furniture-related merchandise, books, gifts", "Yes", "—")
...
add("shop.atbgame.com", "TRUE", 1, "Unit 105-211 Bannatyne Ave, Winnipeg, MB R3B 3P2, Canada", "$200K-$500K (Low confidence)", "1 board game cafe/retail shop in Winnipeg Exchange District; board games, cafe", "Yes", "—")
...
add("noirleather.com", "TRUE", 1, "124 W. Fourth Street, Royal Oak, MI 48067", "$500K-$1.5M (Low confidence)", "1 fetish/alternative fashion retail store; BDSM gear, leather apparel, fetish products", "Review Needed", "Sells BDSM/fetish products; sex toys and adult novelty items are allowed per Shopify Payments; verify no sexually explicit content")
...
add("tapnrollva.com", "TRUE", 1, "410 Lightfoot Rd, Suite G, Williamsburg, VA 23188", "$200K-$500K (Low confidence)", "1 tape/packaging supply retail location in Williamsburg VA", "Yes", "—")
add("qdjewelers.com", "TRUE", 1, "861 6th Ave, Suite 165, San Diego, CA 92101", "$500K-$2M (Low confidence)", "1 jewelry store in San Diego CA; fine jewelry, diamonds, watches", "Yes", "—")
add("www.laidrey.com", "TRUE", 3, "18600 Ventura Blvd, Tarzana, CA; 17034 Ventura Blvd, Encino, CA; 5021 Kanan Rd, Agoura Hills, CA", "$1M-$3M (Medium confidence)", "3 coffee shop locations in Los Angeles area; specialty coffee roaster", "Yes", "—")
add("www.ironaccents.com", "TRUE", 3, "Clermont, GA; 135 E Pike St, Lawrenceville, GA; Gainesville, GA", "$1M-$3M (Low confidence)", "3 wrought iron home decor stores in Georgia; wrought iron furniture, decor, accessories", "Yes", "—")
add("simplytorn.shop", "TRUE", 3, "Ada, OH; Lima, OH; Bellefontaine, OH", "$500K-$1.5M (Low confidence)", "3 women's clothing boutiques in Ohio; fashion, accessories", "Yes", "—")
add("sweetexpressionsbygeri.com", "TRUE", 1, "26 Broadway, Denville, NJ 07834", "$200K-$500K (Low confidence)", "1 gift/expressions shop in Denville NJ; gifts, cards, keepsakes", "Yes", "—")
add("popcornmachine.ca", "TRUE", 1, "4288 Bartlett Rd, Beamsville, ON L3J 0Y9", "$500K-$1.5M (Low confidence)", "1 popcorn machine and supplies retail location in Beamsville ON; commercial and home popcorn equipment", "Yes", "—")
add("tapnrollsingles.com", "FALSE", 0, "N/A", "$100K-$300K (Low confidence)", "Online packaging/tape supply retailer", "Yes", "—")
add("guttercleaningbusiness.com", "FALSE", 0, "N/A", "$200K-$500K (Low confidence)", "Online gutter cleaning equipment and business supplies retailer", "Yes", "—")
...
add("acadian-sturgeon-and-caviar-inc.myshopify.com", "TRUE", 1, "248 Douglas Avenue, Saint John, NB, Canada; hatchery at 30 Carters Wharf Rd, Carters Point, NB E5S 1S5", "$500K-$2M (Low confidence)", "1 retail store in Saint John NB; sturgeon, caviar; hatchery visits at Carters Point", "Yes", "—")
